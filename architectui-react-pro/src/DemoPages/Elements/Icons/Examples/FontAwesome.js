...
import { fab, faFontAwesome, faInternetExplorer } from "@fortawesome/free-brands-svg-icons";
import {
  faCoffee,
  faCog,
  faSpinner,
                      ...
                      <Row>
                        ...
                        <Col md="2">
                          <div className="font-icon-wrapper text-danger">
                            <FontAwesomeIcon icon={faCog} spin fixedWidth={false} size="4x"/>
                        ...
                        <Col md="2">
                          <div className="font-icon-wrapper text-warning">
                            <FontAwesomeIcon icon={faInternetExplorer} flip="both" size="4x"/>
                            <p>flip="both" size="4x"</p>
                          </div>
                        </Col>
                        <Col md="2">
                          <div className="font-icon-wrapper text-dark">
                            <FontAwesomeIcon icon={faFontAwesome} size="4x" transform="left-1 rotate-15" />
                      ...
                      <Row>
                        ...
                        <Col md="2">
                          <div className="font-icon-wrapper">
                            ...
                            <p>faAngleRight size="2x"</p>
                          </div>
                        </Col>
                        <Col md="2">
                          <div className="font-icon-wrapper">
                            <FontAwesomeIcon icon={faAngleUp} size="2x" />
                            <p>faAngleUp size="2x"</p>
                          </div>
                        </Col>
                        <Col md="2">
                          <div className="font-icon-wrapper">
                        ...
                        <Col md="2">
                          <div className="font-icon-wrapper">
                            ...
                            <p>faAppleAlt size="2x"</p>
                          </div>
                        </Col>
                        <Col md="2">
                          <div className="font-icon-wrapper">
                            <FontAwesomeIcon icon={faArchive} size="2x" />
                            <p>faArchive size="2x"</p>
                          </div>
                        </Col>
                        <Col md="2">
                          <div className="font-icon-wrapper">
                            <FontAwesomeIcon icon={faArchway} size="2x" />
                            <p>faArchway size="2x"</p>
                          </div>
                        </Col>
                        <Col md="2">
                          <div className="font-icon-wrapper">
                            <FontAwesomeIcon icon={faArrowAltCircleDown} size="2x"/>
                            <p>faArrowAltCircleDown size="2x"</p>
                          </div>
                        </Col>
                        <Col md="2">
                          <div className="font-icon-wrapper">
                            <FontAwesomeIcon icon={faArrowAltCircleLeft} size="2x"/>
                            <p>faArrowAltCircleLeft size="2x"</p>
                          </div>
                        </Col>
                        <Col md="2">
                          <div className="font-icon-wrapper">
                            <FontAwesomeIcon icon={faArrowAltCircleRight} size="2x"/>
                            <p>faArrowAltCircleRight size="2x"</p>
                          </div>
                        </Col>
                        <Col md="2">
                          <div className="font-icon-wrapper">
                            <FontAwesomeIcon icon={faArrowAltCircleUp} size="2x"/>
                            <p>faArrowAltCircleUp size="2x"</p>
                          </div>
                        </Col>
                        <Col md="2">
                          <div className="font-icon-wrapper">
                            <FontAwesomeIcon icon={faArrowCircleDown} size="2x" />
                            <p>faArrowCircleDown size="2x"</p>
                          </div>
                        </Col>
                        <Col md="2">
                          <div className="font-icon-wrapper">
                            <FontAwesomeIcon icon={faArrowCircleLeft} size="2x" />
                            <p>faArrowCircleLeft size="2x"</p>
                          </div>
                        </Col>
                        <Col md="2">
                          <div className="font-icon-wrapper">
                            <FontAwesomeIcon icon={faArrowCircleRight} size="2x" />
                            <p>faArrowCircleRight size="2x"</p>
                          </div>
                        </Col>
                        <Col md="2">
                          <div className="font-icon-wrapper">
                            <FontAwesomeIcon icon={faArrowCircleUp} size="2x" />
                            <p>faArrowCircleUp size="2x"</p>
                          </div>
                        </Col>
                        <Col md="2">
                          <div className="font-icon-wrapper">
                            <FontAwesomeIcon icon={faArrowDown} size="2x" />
                            <p>faArrowDown size="2x"</p>
                          </div>
                        </Col>
                        <Col md="2">
                          <div className="font-icon-wrapper">
                            <FontAwesomeIcon icon={faArrowLeft} size="2x" />
                            <p>faArrowLeft size="2x"</p>
                          </div>
                        </Col>
                      </Row>
                    </CardBody>
