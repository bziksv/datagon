...
// Simplified CountUp - just shows the end value
const InteractiveCountUp = ({ start = 0, end, duration = 2, delay = 0 }) => {
  return (
                  ...
                  <Col lg="6">
                    ...
                    <Card className="main-card mb-3">
                      <CardBody>
                        ...
                        <h3>
                          <InteractiveCountUp start={56} end={268} duration={15} delay={3} />
                        </h3>
                      </CardBody>
                    </Card>
                  </Col>
                  <Col lg="6">
                    <Card className="main-card mb-3">
                      <CardBody>
                        ...
                        <InteractiveCountUp start={-875.039} end={160527.012} duration={2.75} />
                      </CardBody>
                    </Card>
                  </Col>
                </Row>
