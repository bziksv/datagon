...
// New component that uses the useTour hook
function TourControls({ children }) {
...
class GuidedToursExample extends Component {
  ...
  keyHandling = (e) => {
    if (e.keyCode === 75) {
      e.preventDefault();
      // This will be handled by the TourControls component
    }
  };
              ...
              <Row>
                <Col md="12">
                  <Card className="main-card mb-3">
                    <CardBody>
                      <TourControls>
                        <Demo toggleShowMore={this.toggleShowMore} isShowingMore={isShowingMore}/>
                      </TourControls>
                    </CardBody>
                  </Card>
                </Col>
...
const tourConfig = [
  ...
  },
  {
    ...
    mutationObservables: ['[data-tut="reactour__state--observe"]'],
  },
];
