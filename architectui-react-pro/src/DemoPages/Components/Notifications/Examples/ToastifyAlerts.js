...
// Define toast types manually since toast.TYPE is undefined in newer versions
const toastTypes = {
  DEFAULT: 'default',
  SUCCESS: 'success',
  ERROR: 'error',
...
const defaultState = {
  // Manual defaults since ToastContainer.defaultProps is undefined in newer versions
  position: "top-right",
  autoClose: 5000,
  ...
  render() {
    return (
      <Fragment>
                    ...
                    <Row>
                      <Col md="2">
                        <div>
                          <h5>Color States</h5>
                          <div>
                            <Radio options={toastTypes} name="type" checked={this.state.type} onChange={this.handleRadioOrSelect}/>
                          </div>
                        </div>
                      </Col>
                      <Col md="4">
        ...
        {/* ToastContainer is required for toastify to work */}
        <ToastContainer
          ...
          pauseOnFocusLoss={this.state.pauseOnFocusLoss}
          rtl={this.state.rtl}
