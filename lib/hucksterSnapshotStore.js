...
/**
 * Сохраняет последний успешный результат двух матриц Huckster (JSON).
 * @param {import('mysql2/promise').Pool} db
 * @param {{ success?: boolean, updated_at?: string, sheet_export?: { rows?: unknown[], total_uids?: number, unit_gap_shop_indexes_by_uid?: Record<string, number[]> }, sheet_export_rrc?: { rows?: unknown[], total_uids?: number, unit_gap_shop_indexes_by_uid?: Record<string, number[]> } }} payload
 */
