...
const AUTO_SYNC_TASKS = [
    ...
    {
        key: 'moysklad',
        title: 'МойСклад: ms_export (МСК)',
        subtitle:
            'Номенклатура, остатки, неснижаемый из МС; после сохранения ms_export — журнал нулевых остатков за сегодня (склад.поз. «Да», не архив). Не импорт отгрузок.',
        configKeys: {
    ...
    },
    {
        ...
        defaults: { enabled: 0, time: '21:00' }
    },
    {
        key: 'mssales',
        title: 'Продажи МС',
        subtitle: 'Импорт entity/demand → ms_demand / ms_demand_position',
        configKeys: {
    ...
    {
        key: 'mssales_full',
        title: 'Продажи МС (полный)',
        subtitle: 'Тот же импорт demand, режим fresh (полное окно + soft-delete)',
        configKeys: {
    ...
    {
        key: 'purchase_warmup',
        title: 'Закупки: прогрев снимка',
        subtitle: 'Кэш таблицы /purchase.html (снимок + все сортировки)',
        configKeys: {
            enabled: 'auto_sync_purchase_warmup_enabled',
            time: 'auto_sync_purchase_warmup_time'
        },
        defaults: { enabled: 1, time: '08:00' }
    }
];
