...
const AUTO_SYNC_TASKS = [
    ...
    },
    {
        key: 'medmarket',
        category: 'import_ms',
        title: 'Медмаркет: атрибут из карточек МС',
        subtitle: 'Атрибут «Код товара для медмаркета» из ms_entity_details → ms_export (как на Мой Склад)',
        configKeys: {
            enabled: 'auto_sync_medmarket_enabled',
            time: 'auto_sync_medmarket_time',
            extras: [{ key: 'auto_sync_medmarket_weekdays', label: 'Дни недели (МСК)', default: '1,4', type: 'weekdays' }]
        },
        defaults: { enabled: 0, time: '09:00', extras: { auto_sync_medmarket_weekdays: '1,4' } }
    }
];
