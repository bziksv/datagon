 ...
 * @param {number|null|undefined} [overrideDays] — дни с карточки поставщика (сильнее глобали)
 */
function resolveReplenishmentFromSettings(a, salesWindowDays, overrideDays) {
...
function parseFormulaSettings(appSettings, opts) {
    ...
    const rep = resolveReplenishmentFromSettings(a, salesWindowDays, o.replenishmentDaysOverride);
    return {
