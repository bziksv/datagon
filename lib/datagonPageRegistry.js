...
const PAGE_DEFS = [
    ...
    { key: 'ms-orders', title: 'Заказы в МС', htmlFile: 'ms-orders.html', navSlug: 'ms-orders', sortOrder: 125 },
    { key: 'ms-sales', title: 'Продажи МС', htmlFile: 'ms-sales.html', navSlug: 'ms-sales', sortOrder: 126 },
];
...
const API_PREFIX_RULES = [
    ...
    ['/exports/new-products/crm-task-links', 'exports-new-products-stats'],
