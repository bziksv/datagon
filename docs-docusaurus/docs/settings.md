...
| `sales_formula_*` | Формула продаж на [карточке товара](/docs/product): окно в календарных днях, коэффициент пополнения, редкие/дорогие ветки, режим экономии, ограничение скачка. См. `lib/datagonSalesFormula.js`. |
