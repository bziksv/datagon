...
|---|---|---|---|
| `public/dashboard.html` | `/dashboard` | `src/pages/Dashboard/OverviewPage.tsx` | P1 |
...
| `public/docs/index.html` (главная справки) | `/docs/` | `src/pages/Docs/DocsPage.tsx` (или external link) | P4 |
...
- [ ] Актуализировать `README.md`, страницу [REST API](/docs/api/), пересборку `public/docs/`, smoke e2e.
