...
(function () {
  ...
  document.addEventListener("pointerdown", function (e) {
    ...
    if (t.closest(".app-main__outer, .app-main__inner, .table-responsive, .datagon-my-products-table-wrap, .dg-mp-table-scroll-outer, .dg-sp-table-scroll-outer")) {
      closeAllDropdowns();
      stopFooterPopoverScrollWatcher();
    }
  }, { passive: true });
